...
#include<string.h>
#include "/home/shady/git/postgresql/install/include/libpq-fe.h"
//#include "fmgr.h"
...
exec_simple_query(const char* query_string){
	 ...
	 */
			...
			char token[100]; // Assuming a maximum token length of 50 characters
	...
	if(strcmp(token,"localOfRemote")==0)
	{
		char new_query[1200];
		strcpy(backup_query,query_string);
		strcpy(new_query,query_string);
		char* final = replaceWord(new_query,"localOfRemote", "cached_student");
